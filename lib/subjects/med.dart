...
class med extends StatelessWidget {
  ...
  med({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);
...
class medScreen extends StatefulWidget {
  ...
  medScreen({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);

  @override
  State createState() => medScreenState(peerId: peerId, peerAvatar: peerAvatar);
}

class medScreenState extends State<medScreen> {
  medScreenState({Key key, @required this.peerId, @required this.peerAvatar});

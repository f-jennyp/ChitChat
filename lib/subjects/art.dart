...
class art extends StatelessWidget {
  ...
  art({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);
...
class artScreen extends StatefulWidget {
  ...
  artScreen({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);

  @override
  State createState() => artScreenState(peerId: peerId, peerAvatar: peerAvatar);
}

class artScreenState extends State<artScreen> {
  artScreenState({Key key, @required this.peerId, @required this.peerAvatar});

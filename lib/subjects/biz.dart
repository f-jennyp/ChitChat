...
class biz extends StatelessWidget {
  ...
  biz({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);
...
class bizScreen extends StatefulWidget {
  ...
  bizScreen({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);

  @override
  State createState() => bizScreenState(peerId: peerId, peerAvatar: peerAvatar);
}

class bizScreenState extends State<bizScreen> {
  bizScreenState({Key key, @required this.peerId, @required this.peerAvatar});
  ...
  readLocal() async {
    ...
    FirebaseFirestore.instance.collection('users').doc(id).update({'chattingWith': groupChatId});

...
class acc extends StatelessWidget {
  ...
  acc({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);
...
class accScreen extends StatefulWidget {
  ...
  accScreen({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);

  @override
  State createState() => accScreenState(peerId: peerId, peerAvatar: peerAvatar);
}

class accScreenState extends State<accScreen> {
  accScreenState({Key key, @required this.peerId, @required this.peerAvatar});

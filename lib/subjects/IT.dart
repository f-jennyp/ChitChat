...
class IT extends StatelessWidget {
  ...
  IT({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);
...
class ITScreen extends StatefulWidget {
  ...
  ITScreen({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);

  @override
  State createState() => ITScreenState(peerId: peerId, peerAvatar: peerAvatar);
}

class ITScreenState extends State<ITScreen> {
  ITScreenState({Key key, @required this.peerId, @required this.peerAvatar});

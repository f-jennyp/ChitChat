...
class law extends StatelessWidget {
  ...
  law({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);
...
class lawScreen extends StatefulWidget {
  ...
  lawScreen({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);

  @override
  State createState() => lawScreenState(peerId: peerId, peerAvatar: peerAvatar);
}

class lawScreenState extends State<lawScreen> {
  lawScreenState({Key key, @required this.peerId, @required this.peerAvatar});

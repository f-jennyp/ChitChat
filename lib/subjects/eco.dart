...
class eco extends StatelessWidget {
  ...
  eco({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);
...
class ecoScreen extends StatefulWidget {
  ...
  ecoScreen({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);

  @override
  State createState() => ecoScreenState(peerId: peerId, peerAvatar: peerAvatar);
}

class ecoScreenState extends State<ecoScreen> {
  ecoScreenState({Key key, @required this.peerId, @required this.peerAvatar});

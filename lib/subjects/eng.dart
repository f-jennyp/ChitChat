...
class eng extends StatelessWidget {
  ...
  eng({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);
...
class engScreen extends StatefulWidget {
  ...
  engScreen({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);

  @override
  State createState() => engScreenState(peerId: peerId, peerAvatar: peerAvatar);
}

class engScreenState extends State<engScreen> {
  engScreenState({Key key, @required this.peerId, @required this.peerAvatar});
